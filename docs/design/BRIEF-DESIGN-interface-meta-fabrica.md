...
| **RAG / Contexto recuperado** | Um nó com `fonte_rag` consulta o Datahouse e recebe um bloco "CONTEXTO RECUPERADO" injetado antes de produzir — a **ponte Datahouse→workflow** e o payoff do flywheel (lift de recuperação provado). | Badge no nó ("consultou datahouse: N chunks") + aresta do dataset até o nó (ponte §6). Emite `rag.consultado`. |
